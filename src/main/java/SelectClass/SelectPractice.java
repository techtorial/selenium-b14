...
public class SelectPractice {
    ...
    2-Get all the options and print them out and size as well(how many options)
    3-Validate(Assert) the default value of box is "UNITED STATES"
     */
    @Test
    public void validateFirstOptionAndPrintAllOptions() {
        ...
        WebElement firstSelectedCountry = countries.getFirstSelectedOption();
        Assert.assertEquals(firstSelectedCountry.getText().trim(), "UNITED STATES");
         /*
         1-I want you choose your country any method you want
          */
        countries.selectByValue("207");
    }
