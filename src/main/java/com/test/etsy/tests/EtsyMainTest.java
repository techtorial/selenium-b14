...
public class EtsyMainTest extends EtsyTestBase{
    ...
    public void validateSearchFunctionality(String search,String word1,String word2,String word3){
        ...
        Assert.assertTrue(etsyMainPage.validationOfSearchFunctionality(word1,word2,word3));//firstway
        etsyMainPage.validationOfSearchFunctionality2(word1,word2,word3);//second way
    }
